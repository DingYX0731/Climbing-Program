...
class Trainer(object):
    def __init__(self, model, optimizer, dataloader, graph, lr_scheduler, args, load_state=None):
        ...
        Args:
            ...
            dataloader: A dictionary containing the train, validation, and test data loaders.
            graph: The graph used for training.
            lr_scheduler: The learning rate scheduler.
            args: The arguments passed to the Trainer class.
            load_state: The state to be loaded (optional).
    ...
    def train_epoch(self, epoch, loss_weights):
        ...
        Args:
            ...
            loss_weights (list): List of weights for different loss components.

        Returns:
            tuple: A tuple containing the average training loss and the average separation loss.
        """
        self.model.train()
        print("Training...")
...
def main(args):
    A = load_graph(args.graph_file, args.device)
    print(A.device)
